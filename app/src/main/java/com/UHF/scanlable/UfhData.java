...
public class UfhData {
	...
	public static boolean SoundFlag=false;//���ƶ����ź�
	public static boolean SoundTimer=false;//�������أ����˶����źžͷ���
	public static Timer timer;
	private static int notagTime=0;//û�������Ĵ���
	...
	public static void read6c(int selectedEd,int TidFlag){
		try{
			...
			cmdnum = scaned_num;
			Date date1 = new Date();//�������ڵ�����
			long value1 = date1.getTime();//��ú�����
...
//		private static final String "" = null;
		...
		{	
			...
			// UfhData.createTable(UfhData.db);//������
			 if(timer == null)
			 {
				 timer = new Timer();
